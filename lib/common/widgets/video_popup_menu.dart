...
/// 视频卡的「更多」菜单。
///
/// 封面右下角那颗 ⋮ 已经不画了——菜单改由触摸长按、桌面右键、手柄 Y /
/// 遥控器菜单键从这里弹出，锚在卡片自己身上（手柄没有指针位置）。
class VideoPopupMenu {
  const VideoPopupMenu._();

  static const _menuItemHeight = 45.0;
  ...
  static List<PopupMenuEntry<dynamic>> _items({
    required BuildContext context,
    required BaseSimpleVideoItemModel videoItem,
